<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-text-input id="accountNumber" class="block mt-1 w-full" type="text" name="accountNumber" :value="old('acoountNumber')" required autofocus autocomplete="accountNumber" />
